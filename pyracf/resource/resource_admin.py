    ...
    def __init__(
        ...
        self._valid_segment_traits = {
            "base": {
                ...
                "base:member_resources": "racf:member",
            ...
            "svfmr": {
                "svfmr:parameter_list": "racf:parmname",
                "svfmr:script": "racf:script",
            },
            "tme": {

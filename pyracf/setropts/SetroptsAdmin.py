        ...
        while i < len(messages):
            ...
            if " : " in messages[i]:
                ...
                if current_segment:
                    ...
                    profile[field] = clean_and_separate(
                        messages[i].split(" : ")[1].replace(" / ", "/")
                    )
                i += 1
                continue
            ...
            if "IS " in messages[i]:
                ...
                if "CURRENT OPTIONS:" in messages[i] and i < len(messages) - 1:
                    ...
                    if current_segment:
                        profile[current_segment][field] = cast_value(
            ...
            if "ARE " in messages[i]:
                ...
                if current_segment:
                    profile[current_segment][field] = cast_value(
                        messages[i].split("ARE ")[1].strip().lower()
                    )
                else:
                    profile[field] = cast_value(
                        messages[i].split("ARE ")[1].strip().lower()
            ...
            if ", A USERID WILL BE REVOKED." in messages[i]:
                field = "revoke"
                profile[current_segment][field] = cast_value(
                    messages[i].split("AFTER ")[1].split(" CONSECUTIVE")[0].strip()
                )
                i += 1
                continue

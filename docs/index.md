...
The pyRACF implementation relies on the R_SecMgtOper. The architectural decision for this interface can be found [a relative link](./adr/choose-RACF-interface.md)
...
Information on how to build pyRACF is found in the [a relative link](../README.md)

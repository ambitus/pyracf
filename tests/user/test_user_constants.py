...
TEST_ADD_USER_ADDITIONAL_SECRET_ADDED_SUCCESS_LOG = get_sample("add_user_additional_secret_added_success.log")
TEST_ADD_USER_ADDITIONAL_SECRET_ADDED_ERROR_LOG = get_sample("add_user_additional_secret_added_error.log")

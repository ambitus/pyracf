...
TEST_EXTRACT_GROUP_RESULT_INVALID_ATTRIBUTE_ERROR_XML = get_sample(
    "extract_group_result_invalid_attribute_error.xml"
)
TEST_EXTRACT_GROUP_RESULT_INVALID_ATTRIBUTE_ERROR_DICTIONARY = get_sample(
    "extract_group_result_invalid_attribute_error.json"
)

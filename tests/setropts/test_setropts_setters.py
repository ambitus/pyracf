...
class TestSetroptsSetters(unittest.TestCase):
    ...
    def test_setropts_admin_build_add_audit_class_request(self):
        result = self.setropts_admin.add_audit_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_add_active_class_request(self):
        result = self.setropts_admin.add_active_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_add_statistics_class_request(self):
        result = self.setropts_admin.add_statistics_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_add_generic_command_processing_class_request(self):
        result = self.setropts_admin.add_generic_command_processing_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_add_generic_profile_checking_class_request(self):
        result = self.setropts_admin.add_generic_profile_checking_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_add_generic_profile_sharing_class_request(self):
        result = self.setropts_admin.add_generic_profile_sharing_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_add_global_access_class_request(self):
        result = self.setropts_admin.add_global_access_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_add_raclist_class_request(self):
        result = self.setropts_admin.add_raclist_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_remove_audit_class_request(self):
        result = self.setropts_admin.remove_audit_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_remove_active_class_request(self):
        result = self.setropts_admin.remove_active_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_remove_statistics_class_request(self):
        result = self.setropts_admin.remove_statistics_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_remove_generic_command_processing_class_request(self):
        result = self.setropts_admin.remove_generic_command_processing_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_remove_generic_profile_checking_class_request(self):
        result = self.setropts_admin.remove_generic_profile_checking_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_remove_generic_profile_sharing_class_request(self):
        result = self.setropts_admin.remove_generic_profile_sharing_class("elijtest")
        self.assertEqual(
            result,
    ...
    def test_setropts_admin_build_remove_global_access_class_request(self):
        result = self.setropts_admin.remove_global_access_class("elijtest")
        self.assertEqual(
    ...
    def test_setropts_admin_build_remove_raclist_class_request(self):
        result = self.setropts_admin.remove_raclist_class("elijtest")
        self.assertEqual(
